                ...
                <>
                  ...
                  <div className="absolute right-0 top-full mt-1 bg-[#1c1917] border border-stone-600 shadow-lg z-20 overflow-hidden min-w-[80px]">
                    <button
                      ...
                      className={`w-full px-3 py-1.5 text-left text-xs font-mono hover:bg-stone-700 transition-colors flex items-center gap-2 ${
                        locale === 'zh' ? 'text-orange-400 bg-stone-800' : 'text-stone-300'
                      }`}
                    >
                    ...
                    <button
                      onClick={toggleLocale}
                      className={`w-full px-3 py-1.5 text-left text-xs font-mono hover:bg-stone-700 transition-colors flex items-center gap-2 ${
                        locale === 'en' ? 'text-orange-400 bg-stone-800' : 'text-stone-300'
                      }`}
                    >
                      <span className="w-4 text-center">🇺🇸</span>
                      <span>EN</span>
